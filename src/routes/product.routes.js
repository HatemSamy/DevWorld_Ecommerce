...
router.get('/admin', protect, admin, productController.getAllProductsAdmin);
router.get('/admin/:id', protect, admin, productController.getProductAdmin);
router.post('/admin/:id/trending', protect, admin, productController.setTrendingProduct);
